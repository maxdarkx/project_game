...
HD_PWD='C:/Users/Juan Carlos/Documents/Vivado/project_game/project_game.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log juego.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source juego.tcl -notrace
